...
int is_schedulable(int n, float utilization)
{ return utilization <= 1.0; }

void earliest_deadline_first(int n, int exec_time[], int deadline[], int period[])
 {
...
int main()
{ int n; int exec_time[MAX_PROCESSES], deadline[MAX_PROCESSES], period[MAX_PROCESSES]; float utilization = 0.0;
